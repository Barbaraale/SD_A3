...
public class Atendimento implements Interface{
    ...
    //_____________________________ESTOQUE______________________________________
    @Override
    ...
    @Override
    public ArrayList<Integer> estoqueWarning(int l1, int l2, int l3, int s1, int s2, int s3)throws RemoteException{
        avisoEstoque.add(l1);
        avisoEstoque.add(l2);
        avisoEstoque.add(l3);
        avisoEstoque.add(s1);
    ...
    @Override
    public ArrayList<Integer> getEstoqueWarning()throws RemoteException {
        return avisoEstoque;
    }
